...
enum FileCmdID {
  ...
  CID_FILE_REGIST_REQ = 1293,
  CID_FILE_REGIST_RES = 1294
};
bool FileCmdID_IsValid(int value);
const FileCmdID FileCmdID_MIN = CID_FILE_LOGIN_REQ;
const FileCmdID FileCmdID_MAX = CID_FILE_REGIST_RES;
...
enum ResultType {
  ...
  REFUSE_REASON_NO_REGIST_SERVER = 8
};
bool ResultType_IsValid(int value);
const ResultType ResultType_MIN = REFUSE_REASON_NONE;
const ResultType ResultType_MAX = REFUSE_REASON_NO_REGIST_SERVER;
...
enum FileServerError {
  ...
  FILE_SERVER_ERRNO_REGIST_INVALID_TOKEN = 13
};
bool FileServerError_IsValid(int value);
const FileServerError FileServerError_MIN = FILE_SERVER_ERRNO_OK;
const FileServerError FileServerError_MAX = FILE_SERVER_ERRNO_REGIST_INVALID_TOKEN;
