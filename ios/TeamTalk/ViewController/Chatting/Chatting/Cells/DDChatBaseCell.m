...
- (void)setContent:(MTTMessageEntity*)content
{
    ...
    switch (content.msgContentType) {
        case DDMessageTypeImage:
            showMenu = showMenu | DDShowDelete | DDShowRepost | DDShowCopy;
            break;
        case DDMessageTypeText:
            showMenu = showMenu | DDShowDelete | DDShowRepost | DDShowCopy;
            break;
        case DDMessageTypeVoice:
            showMenu = showMenu | DDShowEarphonePlay | DDShowSpeakerPlay | DDShowDelete | DDShowRepost ;
            break;
...
- (void)clickTheRepost:(MenuImageView *)imageView
{
    //子类去继承
}
@end
