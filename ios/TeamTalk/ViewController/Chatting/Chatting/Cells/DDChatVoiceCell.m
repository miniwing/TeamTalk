...
//    {
//        _voicePath = messageContent[DD_VOICE_LOCAL_KEY];
//    }
//    
//    float voiceLength = [messageContent[VOICE_LENGTH] floatValue];
...
//    
//    NSUInteger timeLength = [messageContent[VOICE_LENGTH] longValue];
...
//    NSString* locaPath = dic[DD_VOICE_LOCAL_KEY];
//    if (!locaPath)
//    {
//        [self showSendFailure];
//        return ;
//    }
//    [[DDSendVoiceMessageAPI sharedVoiceCache] uploadVoice:locaPath success:^(NSString *imageURL) {
...
//        [mutalMessageContent setValue:imageURL forKey:DD_VOICE_URL_KEY];
