...
typedef NS_ENUM(SInt32, MsgType) {
  ...
  MsgTypeMsgTypeSingleImage = 3,
  MsgTypeMsgTypeSingleLocation = 4,
  MsgTypeMsgTypeSingleVideo = 5,
  MsgTypeMsgTypeSingleUrl = 6,
  MsgTypeMsgTypeSingleFile = 7,
  MsgTypeMsgTypeSingleEmotion = 8,
  MsgTypeMsgTypeGroupText = 17,
  MsgTypeMsgTypeGroupAudio = 18,
  MsgTypeMsgTypeGroupImage = 19,
  MsgTypeMsgTypeGroupLocation = 20,
  MsgTypeMsgTypeGroupVideo = 21,
  MsgTypeMsgTypeGroupUrl = 22,
  MsgTypeMsgTypeGroupFile = 23,
  MsgTypeMsgTypeGroupEmotion = 24,
};
...
@property (readonly) UInt32 isFriend;
