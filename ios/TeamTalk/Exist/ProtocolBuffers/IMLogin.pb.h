...
@class IMModifyPassReqBuilder;
@class IMModifyPassRes;
@class IMModifyPassResBuilder;
@class IMMsgServReq;
...
#define IMModifyPassReq_user_id @"userId"
#define IMModifyPassReq_old_pass @"oldPass"
#define IMModifyPassReq_new_pass @"newPass"
...
- (BOOL) hasAttachData;
@property (readonly) UInt32 userId;
@property (readonly, strong) NSString* oldPass;
@property (readonly, strong) NS_RETURNS_NOT_RETAINED NSString* newPass;
@property (readonly, strong) NSData* attachData;
...
- (BOOL) hasNewPass;
- (NSString*) newPass NS_RETURNS_NOT_RETAINED;
