...
NSString *NSStringFromMsgType(MsgType value) {
  switch (value) {
    ...
    case MsgTypeMsgTypeSingleImage:
      return @"MsgTypeMsgTypeSingleImage";
    case MsgTypeMsgTypeSingleLocation:
      return @"MsgTypeMsgTypeSingleLocation";
    case MsgTypeMsgTypeSingleVideo:
      return @"MsgTypeMsgTypeSingleVideo";
    case MsgTypeMsgTypeSingleUrl:
      return @"MsgTypeMsgTypeSingleUrl";
    case MsgTypeMsgTypeSingleFile:
      return @"MsgTypeMsgTypeSingleFile";
    case MsgTypeMsgTypeSingleEmotion:
      return @"MsgTypeMsgTypeSingleEmotion";
    case MsgTypeMsgTypeGroupText:
      return @"MsgTypeMsgTypeGroupText";
    case MsgTypeMsgTypeGroupAudio:
      return @"MsgTypeMsgTypeGroupAudio";
    case MsgTypeMsgTypeGroupImage:
      return @"MsgTypeMsgTypeGroupImage";
    case MsgTypeMsgTypeGroupLocation:
      return @"MsgTypeMsgTypeGroupLocation";
    case MsgTypeMsgTypeGroupVideo:
      return @"MsgTypeMsgTypeGroupVideo";
    case MsgTypeMsgTypeGroupUrl:
      return @"MsgTypeMsgTypeGroupUrl";
    case MsgTypeMsgTypeGroupFile:
      return @"MsgTypeMsgTypeGroupFile";
    case MsgTypeMsgTypeGroupEmotion:
      return @"MsgTypeMsgTypeGroupEmotion";
    default:
      return nil;
  }
}
...
- (void) setHasIsFriend:(BOOL) _value_ {
  hasIsFriend_ = !!_value_;
}
@synthesize isFriend;
- (instancetype) init {
  if ((self = [super init])) {
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasIsFriend) {
    [output writeUInt32:12 value:self.isFriend];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
- (SInt32) serializedSize {
  ...
  if (self.hasIsFriend) {
    size_ += computeUInt32Size(12, self.isFriend);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  ...
  if (self.hasIsFriend) {
    [output appendFormat:@"%@%@: %@\n", indent, @"isFriend", [NSNumber numberWithInteger:self.isFriend]];
  }
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  ...
  if (self.hasIsFriend) {
    [dictionary setObject: [NSNumber numberWithInteger:self.isFriend] forKey: @"isFriend"];
  }
  [self.unknownFields storeInDictionary:dictionary];
}
- (BOOL) isEqual:(id)other {
  ...
  return
      ...
      self.hasIsFriend == otherMessage.hasIsFriend &&
      (!self.hasIsFriend || self.isFriend == otherMessage.isFriend) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  __block NSUInteger hashCode = 7;
  ...
  if (self.hasIsFriend) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInteger:self.isFriend] hash];
  }
  hashCode = hashCode * 31 + [self.unknownFields hash];
  return hashCode;
}
...
- (UserInfoBuilder*) mergeFrom:(UserInfo*) other {
  ...
  if (other.hasIsFriend) {
    [self setIsFriend:other.isFriend];
  }
  [self mergeUnknownFields:other.unknownFields];
  return self;
}
...
- (UserInfoBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 96: {
        [self setIsFriend:[input readUInt32]];
        break;
      }
    }
  }
...
- (BOOL) hasIsFriend {
  return resultUserInfo.hasIsFriend;
}
- (UInt32) isFriend {
  return resultUserInfo.isFriend;
}
- (UserInfoBuilder*) setIsFriend:(UInt32) value {
  resultUserInfo.hasIsFriend = YES;
  resultUserInfo.isFriend = value;
  return self;
}
- (UserInfoBuilder*) clearIsFriend {
  resultUserInfo.hasIsFriend = NO;
  resultUserInfo.isFriend = 0;
  return self;
}
@end
