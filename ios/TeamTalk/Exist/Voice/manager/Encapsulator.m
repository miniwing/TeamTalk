...
- (void)prepareForEncapsulating {
   ...
   //写入一些数据之前的头
   [encapsulationOperation writeHeaderWithComment:@"Encoded with:test by HARRY "];
...
- (void)encapsulatingOver:(NSNotification *)notification {
   ...
   LogDebug((@"encapsulatingOver by %@", [self description]));
...
- (void)writeHeaderWithComment:(NSString *)comment {
   ...
   unsigned char speexHeader[80] = {0};
