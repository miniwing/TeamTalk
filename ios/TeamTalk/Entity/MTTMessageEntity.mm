    ...
    if (module.MTTSessionEntity.sessionType == SessionTypeSessionTypeSingle ) {
        switch (type) {
            ...
            case DDMessageTypeImage:
                msgType = MsgTypeMsgTypeSingleImage;
                break;
            case DDMEssageTypeLocation:
                msgType = MsgTypeMsgTypeSingleLocation;
                break;
            case DDMessageTypeVoice:
                msgType = MsgTypeMsgTypeSingleAudio;
                break;
            case DDMEssageTypeVideo:
                msgType = MsgTypeMsgTypeSingleVideo;
                break;
            case DDMEssageTypeURL:
                msgType = MsgTypeMsgTypeSingleUrl;
                break;
            case DDMEssageTypeFile:
                msgType = MsgTypeMsgTypeSingleFile;
                break;
            case DDMEssageEmotion:
                msgType = MsgTypeMsgTypeSingleEmotion;
                break;
            default:
                msgType =MsgTypeMsgTypeSingleText;
                break;
    ...
    }else
    {
        switch (type) {
            case DDMessageTypeText:
                ...
                break;
            case DDMessageTypeImage:
                msgType = MsgTypeMsgTypeGroupImage;
                break;
            case DDMEssageTypeLocation:
                msgType = MsgTypeMsgTypeGroupLocation;
                break;
            case DDMessageTypeVoice:
                msgType = MsgTypeMsgTypeGroupAudio;
                break;
            case DDMEssageTypeVideo:
                msgType = MsgTypeMsgTypeGroupVideo;
                break;
            case DDMEssageTypeURL:
                msgType = MsgTypeMsgTypeGroupUrl;
                break;
            case DDMEssageTypeFile:
                msgType = MsgTypeMsgTypeGroupFile;
                break;
            case DDMEssageEmotion:
                msgType = MsgTypeMsgTypeGroupEmotion;
                break;
            default:
                msgType =MsgTypeMsgTypeGroupText;
                break;
