...
typedef NS_ENUM(NSUInteger, DDMessageContentType)
{
    ...
    DDMEssageEmotion    =3,
    DDMEssageTypeLocation   =4,
    DDMEssageTypeVideo      =5,
    DDMEssageTypeURL        =6,
    DDMEssageTypeFile        =7
//    MSG_TYPE_AUDIO	= 100,
...
#define DD_VOICE_LOCAL_KEY                  @"local"
#define DD_VOICE_URL_KEY                    @"url"
...
//location
#define DD_LOCATION_LAT_KEY                 @"lat"
#define DD_LOCATION_LNG_KEY                 @"lng"
#define DD_LOCATION_ADDRESS_KEY             @"addr"
//商品
